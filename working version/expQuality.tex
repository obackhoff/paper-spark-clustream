...
The number of micro-clusters was set to $q=50$, 10 times the number of final clusters ($5$). \color{red}@Omar: they suggest 50 and 5 in the original paper?\color{black}.
...
The test ran 4 times for \textit{Spark-CluStream} to average the results. \color{red} Same for DS1? You run the streams x4 and reported the avg values over the 4 runs?\color{black}
